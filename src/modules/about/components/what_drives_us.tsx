  ...
  return (
    <section className="py-20 px-4">
      <div className="container mx-auto flex flex-col gap-12">
        ...
        {/* Mission */}
        <div className="bg-white shadow-sm rounded-xl p-8 border border-gray-100 w-full md:max-w-5xl max-w-7xl">
        ...
        {/* Vision */}
        <div className="bg-white shadow-sm rounded-xl p-8 border border-gray-100 max-w-3xl ml-auto">
          <div className="flex flex-col items-start gap-4 mb-2">
            <div className="w-10 h-10 rounded bg-[#D4A34A] flex items-center justify-center">
              <p>
                <Eye color="white" />
